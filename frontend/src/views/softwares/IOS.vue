...
const architectures = [
  { label: 'Apple Silicon (arm64)', value: 'arm64' }
]

const versions = ['v1.0.0', 'v0.9.5', 'v0.9.0']

const downloadiOS = () => {
  Snackbar.success(`开始下载 iOS ${architecture.value} 架构 ${version.value} 版本 EasyTier`)
}
</script>

<template>
  <var-paper :elevation="2" class="software-page">
    <h2 class="page-title">iOS 客户端</h2>
    ...
    <var-paper :elevation="0" class="download-section">
      ...
      <var-space direction="column" :size="[16, 0]">
        ...
        <var-button type="primary" size="large" @click="downloadiOS" block>
    ...
    <var-paper :elevation="0" class="instructions-section">
      ...
      <var-space direction="column" :size="[16, 0]">
        ...
        <var-list>
          ...
          <var-list-item>通过 TestFlight 或其他方式安装</var-list-item>
