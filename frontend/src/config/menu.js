...
export const menuTree = [
  ...
  { key: 'software', label: '应用', icon: 'shopping-outline', title: '软件下载',
    children: [
      { key: 'softwares-windows', label: 'Windows', icon: './public/svg/windows.svg', component: 'softwares/Windows' },
      { key: 'softwares-android', label: 'Android', icon: './public/svg/android.svg', component: 'softwares/Android' },
      { key: 'softwares-macos', label: 'MacOS', icon: './public/svg/mac.svg', component: 'softwares/MacOS' },
      { key: 'softwares-ios', label: 'IOS', icon: './public/svg/ios.svg', component: 'softwares/IOS' },
      { key: 'softwares-harmonyos', label: '鸿蒙', icon: './public/svg/harmony.svg', component: 'softwares/HarmonyOS' },
      { key: 'softwares-linux', label: 'Linux', icon: './public/svg/linux.svg', component: 'softwares/Linux' },
    ]
  },
